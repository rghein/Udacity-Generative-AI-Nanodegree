...
├── batch_eval.py           # Load test questions and compute metrics
├── evaluation_dataset.txt  # Test file for batch_eval.py
├── test_questions.json     # Test file for batch_eval.py
...
#### 6. **Batch Evaluation (`batch_eval.py`)**
